...
class Trie:
    ...
    O(number*m)
    number - число узлов в префиксном дереве. Также в каждом узле дерева хранится словарь детей для символа.
    Максимальное значение длины словаря - это число символов в алфавите. Пусть в алфавите m - символов. Тогда сложность
    по памяти -О(number*m)
    """
